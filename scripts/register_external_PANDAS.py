# bash:   brownie run ./scripts/register_external_PANDAS.py main <account> 
...
MYTOKENS = {
    0: "0xfD561eF343D3f9D8d855c4b4ae3bCa2C42Ae0f8f",    # ETHEREUM Görli
    1: "0x01F94A5ba5C972Fb01F41B6EDDc786e417099ED4",    # BNB Chain
    3: "0x5fb444a9956e1834aBB5bA4dEBc61D90df863F85",    # AVALANCHE Fuji 
    5: "0x5ceCc8CfE5CCd7b00F5c8c2EA4F4ae21789822bD",    # POLYGON MUMBAI
    6: "0x5fb444a9956e1834aBB5bA4dEBc61D90df863F85",    # CRONOS
    7: "0xE93D3c4BCFAC2ECee0775DEC79785Cd23bA0a583",    # FANTOM
    8: "0x9b8Ec37Bbf638Ce346e1beb5b4E33B640aA26D31"     # CELO ALFAJORES
    }
...
def main(account_name: str) -> None:
    ...
    print("*********************************************************")
    print("***                                                   ***")
    print("***           PANDAS Token ext. Registration          ***")
    print("***                                                   ***")
            ...
            if brownie.network.is_connected()==False:
                ...
                if MYTOKENS[blockchain.value]=="":
                    ...
                    try:
                        ...
                        PantosForwarder= brownie.Contract.from_abi("PantosForwarder", my_pandas_token.getPantosForwarder(), pantos_forwarder_abi_data['abi'])
                        PantosHub = brownie.Contract.from_abi("PantosHub", PantosForwarder.getPantosHub(), pantos_hub_abi_data['abi'])
                        ...
                        print("External Registering ...      ")
                        
                        for x in Blockchain:
                            if x == blockchain:
                                print("ID ",x.value,": *** IGNORED ***")
                            else:
                                PantosHub.registerExternalToken(my_pandas_token.address, x.value, MYTOKENS[x].encode('utf-8').strip(), transaction_parameters)
                                print("ID ",x.value,": *** DONE ***")
